...
const Courses = async () => {
    ...
    return (
        <div className='  md:grid md:grid-cols-[70%_30%]   '>
            <div className='flex flex-col w-[95%] md:w-[90%] mx-auto md:min-h-[50vh]
             bg-white mt-4
             md:ml-6 rounded-xl  overflow-x-hidden'>
                ...
                {courses.map((course) => {
                    return (
                        <Link href={`/Teacher/Courses/Details/${course._id}`} key={course._id}>
                            <div className='md:w-[30%] p-7 border flex bg-blueHover hover:bg-bluePrimary
